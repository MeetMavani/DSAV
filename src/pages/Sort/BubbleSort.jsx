...
import { bubbleSort, BubbleSortCodeSnippets } from "../../utils/sortingAlgorithms";
...
const BubbleSort = () => {
  ...
  return (
    <section className="flex flex-col max-w-7xl mx-auto px-4 py-8 md:px-12 lg:px-24 bg-emerald-50">
      {/* Big Heading */}
      ...
      <ul className="list-disc text-gray-600 space-y-4 text-left">
        ...
        <SortingVisualizer title="Bubble" algorithmFn={bubbleSort}/>
